                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nitrous-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nitrous address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nitrous: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nitrous Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nitrous Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nitrous"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nitrous addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nitrous addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nitrous: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nitrous Core help message to get a list with possible Nitrous command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nitrous Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Nitrous Core"); // default title
