...
RESOURCES += src/qt/nitrous.qrc src/qt/nitrous_locale.qrc

TRANSLATIONS += src/qt/locale/nitrous_bg.ts \
                src/qt/locale/nitrous_de.ts \
                src/qt/locale/nitrous_en.ts \
                src/qt/locale/nitrous_es.ts \
                src/qt/locale/nitrous_fi.ts \
                src/qt/locale/nitrous_fr.ts \
                src/qt/locale/nitrous_it.ts \
                src/qt/locale/nitrous_ja.ts \
                src/qt/locale/nitrous_pl.ts \
                src/qt/locale/nitrous_pt.ts \
                src/qt/locale/nitrous_ru.ts \
                src/qt/locale/nitrous_sk.ts \
                src/qt/locale/nitrous_sv.ts \
                src/qt/locale/nitrous_vi.ts \
                src/qt/locale/nitrous_zh_CN.ts \
                src/qt/locale/nitrous_zh_TW.ts
