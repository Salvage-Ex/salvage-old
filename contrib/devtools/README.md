...
Setup
---------
Configuring the github-merge tool for the SVG repository is done in the following way:

    git config githubmerge.repository SVG-Project/SVG
...
A script to optimize png files in the SVG
