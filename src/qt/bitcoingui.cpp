                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Salvage-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Salvage address"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Salvage addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Salvage addresses"));
