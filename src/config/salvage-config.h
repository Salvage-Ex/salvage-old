/* src/config/salvage-config.h.  Generated from salvage-config.h.in by configure.  */
/* src/config/salvage-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://salvage.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Salvage Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Salvage Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "salvage"
