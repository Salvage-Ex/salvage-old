...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nitrous Core nitrous-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nitrous-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nitrous transaction") + "\n" +
                               "  nitrous-tx [options] -create [commands]   " + _("Create hex-encoded nitrous transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nitrous transaction
