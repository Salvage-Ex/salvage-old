/* src/config/nitrous-config.h.  Generated from nitrous-config.h.in by configure.  */
/* src/config/nitrous-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://nitrous.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Nitrous Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Nitrous Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nitrous"
